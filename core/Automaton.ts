...
import { QuadLifeAutomaton } from "../2d/quadlife"
import { CCA3D } from "../3d/cca"
	...
	static async create(
		...
		try {
			...
			switch (settings.algo) {
				...
				case "langton-webgl":
					return new Langton2DWebGL(canvasEl, width, height, paletteColors)
				case "entropy":
